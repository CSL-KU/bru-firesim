...
class RuntimeHWConfig:
    ...
    def get_boot_simulation_command(self, macaddr, blkdev, slotid,
        ...
        driverArgs = """+permissive $(sed \':a;N;$!ba;s/\\n/ /g\' {runtimeconf}) +macaddr0={macaddr} +slotid={slotid} +niclog0=niclog {tracefile} +trace-start0={trace_start} +trace-end0={trace_end} +linklatency0={linklatency} +netbw0={netbw} +profile-interval={profile_interval} +shmemportname0={shmemportname} +print-no-cycle-prefix +permissive-off +prog0={bootbin}""".format(
